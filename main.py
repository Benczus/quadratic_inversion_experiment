...
from experiment_utils.ga import main_ga_3_d
from function.Polynomial import Polynomial
from util.inversion_processing import process_inversion_results_3_d
...
if __name__ == "__main__":
    ...
    process_inversion_results_3_d(model=model, x_test=quad_x_test, y_test=quad_y_test, z_test=quad_z_test,
                                  ga_inv_value=ga_inv_value, function=quadratic, num_of_rows=num_of_rows)
